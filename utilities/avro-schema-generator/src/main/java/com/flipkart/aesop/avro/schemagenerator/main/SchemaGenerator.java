...
public class SchemaGenerator implements InitializingBean
{
	...
	public String generateSchema(String dbName, String tableName) throws IOException, IllegalArgumentException
	{
		...
		List<TableRecord.Field> fields = MysqlUtils.getFieldDetails(dbName, tableName,"new_", 0);
		fields.addAll(MysqlUtils.getFieldDetails(dbName, tableName,"old_", fields.size()));
		List<String> primaryKeys = MysqlUtils.getPrimaryKeys(dbName, tableName,"new_");
